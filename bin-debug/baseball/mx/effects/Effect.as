        ...
        private static function stripUnchangedValues(param1:Array) : Array
        {
            ...
            while (_loc_2 < param1.length)
            {
                ...
                for (_loc_3 in param1[_loc_2].start)
                {
                    ...
                    if (_loc_5[_loc_3] == param1[_loc_2].end[_loc_3] || typeof(_loc_5[_loc_3]) == "number" && typeof(param1[_loc_2].end[_loc_3]) == "number" && isNaN(_loc_5[_loc_3]) && isNaN(param1[_loc_2].end[_loc_3]))
                    {
