    ...
    public class WindowedApplication extends Application implements IWindow
    {
        ...
        private function window_boundsHandler(event:NativeWindowBoundsEvent) : void
        {
            ...
            else
            {
                ...
                {
                    _loc_4 = true;
                    if (_loc_2.y != event.beforeBounds.y && !isNaN(oldY))
                    {
                        _loc_2.y = oldY;
                    }
        ...
        override protected function commitProperties() : void
        {
            ...
            if (boundsChanged)
            {
                var _loc_6:* = _bounds.width;
                _width = _bounds.width;
                systemManager.stage.stageWidth = _loc_6;
                var _loc_6:* = _bounds.height;
                _height = _bounds.height;
                systemManager.stage.stageHeight = _loc_6;
                boundsChanged = false;
            ...
            {
                var _loc_6:* = systemManager.stage.stageWidth;
                _width = systemManager.stage.stageWidth;
                _bounds.width = _loc_6;
                var _loc_6:* = systemManager.stage.stageHeight;
                _height = systemManager.stage.stageHeight;
                _bounds.height = _loc_6;
            ...
            if (statusBarFactoryChanged)
            {
                ...
                if (gripper)
                {
                    _loc_5 = rawChildren.getChildIndex(DisplayObject(gripper));
                    rawChildren.setChildIndex(DisplayObject(_statusBar), _loc_5);
                }
                statusBarFactoryChanged = false;
                showStatusBarChanged = true;
                statusChanged = true;
