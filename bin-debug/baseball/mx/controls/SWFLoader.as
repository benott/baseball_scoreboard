    ...
    public class SWFLoader extends UIComponent implements ISWFLoader
    {
        ...
        private function loadContent(param1:Object) : void
        {
            ...
            else if (byteArray)
            {
                ...
                contentHolder = _loc_3;
                addChild(child);
                _loc_3.contentLoaderInfo.addEventListener(Event.COMPLETE, contentLoaderInfo_completeEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(Event.INIT, contentLoaderInfo_initEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR, contentLoaderInfo_ioErrorEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(Event.UNLOAD, contentLoaderInfo_unloadEventHandler);
                _loc_3.loadBytes(byteArray, loaderContext);
            }
            else if (url)
            {
                loader = new FlexLoader();
                ...
                addChild(loader);
                _loc_3.contentLoaderInfo.addEventListener(Event.COMPLETE, contentLoaderInfo_completeEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(HTTPStatusEvent.HTTP_STATUS, contentLoaderInfo_httpStatusEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(Event.INIT, contentLoaderInfo_initEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR, contentLoaderInfo_ioErrorEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(Event.OPEN, contentLoaderInfo_openEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(ProgressEvent.PROGRESS, contentLoaderInfo_progressEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(SecurityErrorEvent.SECURITY_ERROR, contentLoaderInfo_securityErrorEventHandler);
                _loc_3.contentLoaderInfo.addEventListener(Event.UNLOAD, contentLoaderInfo_unloadEventHandler);
                ...
                if (isContentLoaded)
                {
                    if (contentHolder is Loader)
                    {
                        ...
                        if (useUnloadAndStop && "unloadAndStop" in contentHolder)
                        {
                            ...
                            _loc_3["unloadAndStop"](unloadAndStopGC);
                        }
                        else
                        {
