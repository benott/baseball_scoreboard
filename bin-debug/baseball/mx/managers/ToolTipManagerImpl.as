package mx.managers
{
    ...
    public class ToolTipManagerImpl extends EventDispatcher implements IToolTipManager2
    {
        ...
        public function createToolTip(param1:String, param2:Number, param3:Number, param4:String = null, param5:IUIComponent = null) : IToolTip
        {
            ...
            var _loc_7:* = param5 ? (param5.mx.core:IUIComponent::systemManager as ISystemManager) : (ApplicationGlobals.application.systemManager as ISystemManager);
            _loc_7.topLevelSystemManager.addChildToSandboxRoot("toolTipChildren", _loc_6 as DisplayObject);
            if (param4)
            {
        ...
        function reset() : void
        {
            ...
            if (currentToolTip)
            {
                ...
                _loc_1 = currentToolTip.mx.core:IUIComponent::systemManager as ISystemManager;
        ...
        {
            var _loc_2:* = param1.mx.core:IUIComponent::systemManager as ISystemManager;
        ...
        private function marshalToolTipManagerHandler(event:Event) : void
        {
            ...
            switch(_loc_3.name)
            {
                ...
                case "update":
                {
                    _loc_3.stopImmediatePropagation();
        ...
        {
            return param1 is IUIComponent ? (IUIComponent(param1).mx.core:IUIComponent::systemManager) : (null);
        }// end function
